...
Two backends balanced by NGINX upstream with sticky sessions via a synthesized ROUTEID cookie.
...
NGINX template (`nginx/http/load-balancer/default.conf.template`):
