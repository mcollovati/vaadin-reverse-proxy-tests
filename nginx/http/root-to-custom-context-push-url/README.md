...
# NGINX — root-to-custom-context-push-url

root-to-custom-context with VAADIN_PUSH_URL=/VAADIN/push; adds a dedicated /VAADIN/push location that maps to the backend's /app/VAADIN/push.
...
NGINX template (`nginx/http/root-to-custom-context-push-url/default.conf.template`):
